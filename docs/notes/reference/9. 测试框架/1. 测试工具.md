...
async with PluginTestHarness(
    ...
    plugins_dir=Path("examples/qq/01_hello_world"),
) as h:
...
| 文档 | 说明 |
|------|------|
| [Factory + Scenario + Mock](2.%20工厂场景与%20Mock.md) | 事件工厂、场景构建器、Mock API、Fluent 断言 |
| [测试指南](../../guide/9.%20测试指南/) | 教程风格入门 |
| [Harness 使用详解](../../guide/9.%20测试指南/2.%20测试工具.md) | 实践指南 |
