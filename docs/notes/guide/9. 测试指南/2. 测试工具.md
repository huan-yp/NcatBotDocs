...
async with PluginTestHarness(
    ...
    plugins_dir=Path("examples/qq/01_hello_world"),        # 插件根目录
...
> **plugins_dir** 是包含插件文件夹的**父目录**。例如插件在 `examples/qq/01_hello_world/hello_world/` 下，则 `plugins_dir` 应为 `examples/qq/01_hello_world`。
