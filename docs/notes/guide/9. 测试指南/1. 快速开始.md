...
> 完整列表参见 [MockBotAPI 参考](../../reference/9.%20测试框架/2.%20工厂场景与%20Mock.md#mockbotapi)。
...
| 我想… | 去看 |
|-------|------|
| 深入了解 Harness 能力 | [Harness 详解](2.%20测试工具.md) |
| 学习 Scenario 链式测试 | [工厂与场景](3.%20工厂与场景.md) |
| 查完整 API 签名 | [测试 API 参考](../../reference/9.%20测试框架/) |
