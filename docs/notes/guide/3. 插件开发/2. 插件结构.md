...
> 示例参考：[examples/qq/04_bot_api/](../../../examples/qq/04_bot_api/README.md) 包含 `resources/` 目录。
...
> 取自 [examples/common/07_external_api/manifest.toml](../../../examples/common/07_external_api/README.md)。
