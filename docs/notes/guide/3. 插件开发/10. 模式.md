...
> 示例：[examples/common/07_external_api/manifest.toml](../../../examples/common/07_external_api/README.md) 声明了 `aiohttp` 依赖。
...
> 完整代码：[examples/common/06_multi_step_dialog/main.py](../../../examples/common/06_multi_step_dialog/README.md)
