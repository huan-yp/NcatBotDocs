...
> 取自 [examples/qq/02_event_handling/main.py](../../../examples/qq/02_event_handling/README.md) 的模式 B
...
> 取自 [examples/qq/02_event_handling/main.py](../../../examples/qq/02_event_handling/README.md) 的模式 C
...
> 取自 [examples/common/06_multi_step_dialog/main.py](../../../examples/common/06_multi_step_dialog/README.md)
...
> 完整示例见 [examples/common/07_session_helpers](../../../examples/common/07_session_helpers/README.md)。
...
> 取自 [examples/qq/08_scheduled_reporter/main.py](../../../examples/qq/08_scheduled_reporter/README.md)
