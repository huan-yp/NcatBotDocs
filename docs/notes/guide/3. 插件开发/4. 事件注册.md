...
> 取自 [examples/qq/01_hello_world/main.py](../../../examples/qq/01_hello_world/README.md)
...
> 取自 [examples/qq/04_bot_api/main.py](../../../examples/qq/04_bot_api/README.md) 和 [examples/common/02_config_and_data/main.py](../../../examples/common/02_config_and_data/README.md)
...
> **注意：** `room_info` 仅在开播（`on_live_start`）时填充；下播事件（`on_live_end`）中该字段为 `None`。
...
> 取自 [examples/qq/02_event_handling/main.py](../../../examples/qq/02_event_handling/README.md) 和 [examples/common/02_config_and_data/main.py](../../../examples/common/02_config_and_data/README.md)
