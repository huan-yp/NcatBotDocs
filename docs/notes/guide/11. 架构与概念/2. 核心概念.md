...
**参见**：[适配器参考](<reference/2. 适配器/>)、[多平台开发指南](<guide/10. 多平台开发/>)
...
**参见**：[Hook 机制指南](<guide/3. 插件开发/9. Hooks.md>)、[Registry 参考](<reference/4. 核心模块/3. 注册表.md>)
...
**参见**：[插件开发指南](<guide/3. 插件开发/>)、[插件系统参考](<reference/3. 插件开发/>)
...
**参见**：[消息发送指南](<guide/4. 消息发送/>)、[类型参考](<reference/3. 数据类型/>)
...
**参见**：[RBAC 指南](<guide/7. RBAC 权限/>)、[服务层参考](<reference/6. 服务层/>)
...
**参见**：[Predicate DSL 指南](<guide/3. 插件开发/6. 谓词 DSL.md>)、[Predicate API 参考](<reference/4. 核心模块/2. 谓词系统.md>)
...
**参见**：[架构文档 §4.10](<11. 架构与概念/1. 架构总览.md>)、[Quick Start](<guide/1. 快速开始/>)
